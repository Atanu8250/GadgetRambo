          ...
          <div className={style.paymentTop}>
            ...
            <div className={style.button}>
              <div style={{ display: "flex", justifyContent:"end",gap:"1rem" }}>
                <Button onClick={handlePayment} bgColor={"#eae8e8"}>Proceed To Pay</Button>
                <Link href="./cart"><Button bgColor={"#eae8e8"}>Cancel</Button></Link>
              </div>
            </div>
          </div>
        </div>
        {/* <div style={{width:"20%",margin:"auto"}}> */}
          <Image height={"100%"} width={"45%"} src="https://images.pexels.com/photos/7620576/pexels-photo-7620576.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="payment"/>
        {/* </div> */}
      </div>
